        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          >
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              {t('footer.madeWith') as string} <Heart className="inline w-4 h-4 text-red-500" /> {t('footer.and') as string} Next.js
            </p>
          </motion.div>
          ...
          >
            <p> {currentYear} Portfolio. {t('footer.rights') as string}</p>
          </motion.div>
        </div>
      </div>
    </footer>
