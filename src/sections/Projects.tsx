...
const projectsData = [
  ...
  },
  {
    ...
    description: '基于 Next.js 14 构建的个人作品集网站，18 个源文件，支持暗黑/亮色主题切换、中英文双语、Framer Motion 动画，部署在 Cloudflare Pages 全球 CDN。',
    descriptionEn: 'A personal portfolio website built with Next.js 14, 18 source files, featuring dark/light theme toggle, Chinese/English bilingual support, Framer Motion animations, deployed on Cloudflare Pages global CDN.',
