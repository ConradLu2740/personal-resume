          ...
          >
            ...
            <div>
              ...
              <div className="flex gap-4">
                ...
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M5.721 0C2.251 0 0 2.25 0 5.719V18.28C0 21.751 2.252 24 5.721 24h12.56C21.751 24 24 21.75 24 18.281V5.72C24 2.249 21.75 0 18.281 0zm1.964 4.078h6.789c.077 0 .14.063.14.14v1.263c0 .077-.063.14-.14.14H9.626c-.077 0-.14.063-.14.14v4.328h4.828c.077 0 .14.063.14.14v1.263c0 .077-.063.14-.14.14H9.486v5.016c0 .077-.063.14-.14.14H7.964c-.077 0-.14-.063-.14-.14V4.218c0-.077.063-.14.14-.14h-.28z"/>
                  </svg>
                </motion.a>
              </div>
            </div>
